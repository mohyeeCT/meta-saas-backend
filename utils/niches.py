...
NICHES: dict[str, dict] = {
    ...
    "financial_services": {
        ...
        "context": (
            ...
            "Trust signals: Regulatory approvals and licenses, named financial institution clients, "
            "FCA authorization, security certifications, years of financial services specialization.\n"
    ...
    "hr_recruitment": {
        ...
        "context": (
            ...
            "employment law), cost per hire, sector specialization, post-placement support.\n"
            ...
            "Trust signals: Placement success rate, named employer clients, sector specialization, "
    ...
    "logistics_supply_chain": {
        ...
        "context": (
            ...
            "ISO 9001 or equivalent, years of operation, sector specialization.\n"
    ...
    "law_firm": {
        ...
        "context": (
            ...
            "Trust signals: Legal 500 / Chambers rankings, SRA accreditation, practice area specialization, "
    ...
    "accountancy_tax": {
        ...
        "context": (
            ...
            "fees and value clarity, ease of switching, specialization in their sector or situation.\n"
            ...
            "sector specialization, named client types, specific tax savings examples, Google reviews.\n"
    ...
    "fitness_wellness": {
        ...
        "context": (
            ...
            "Terminology that resonates: transformation, results, accountability, tailored program, "
    ...
    "home_garden": {
        ...
        "context": (
            ...
            "Buyer persona: Homeowner or renter personalizing their living space or tackling a project. "
            ...
            "easy returns, 2-year guarantee, available in X colors.\n"
    ...
    "food_beverage": {
        ...
        "context": (
            ...
            "COMPLIANCE NOTE: Health claims must be authorized under UK/EU food law. "
    ...
    "supplements_nutrition": {
        ...
        "context": (
            ...
            "Only use authorized EU/UK health claims for vitamins and minerals. "
